...
public class GameCameraController : MonoBehaviour
{
	...
	{
		public Vector3 targetPosOffset = new Vector3(0, 0.8f, 0);
	...
	private void Start()
	{
		...
		targetPos = positionSettings.targetPosOffset;
		MoveToTarget();
	...
	private void FixedUpdate()
	{
		...
		collisionHandler.CheckColliding(target.position + positionSettings.targetPosOffset); // using raycast
		positionSettings.adjustmentDistance = collisionHandler.GetAdjustedDistanceWithRayFrom(target.position + positionSettings.targetPosOffset);
	}
